...
export const professionalProfile: ProfessionalProfile = {
  ...
  experiences: [
    ...
    },
    {
      ...
      period: "2025–2026",
      context: "Supply Chain · Inventory · Analytics",
      contributions: [
        "Built operational reporting and inventory visibility dashboards",
        "Automated inbound logistics and validation workflows",
        "Delivered business intelligence supporting supply-chain decisions",
      ],
      capabilities: ["Supply Chain", "Inventory", "Analytics", "Business Intelligence"],
