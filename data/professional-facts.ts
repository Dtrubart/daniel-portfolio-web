...
export const professionalFacts: ProfessionalFacts = {
  ...
  employment: [
    ...
    },
    {
      ...
      contributions: [],
      technologies: [],
      capabilities: ["Operations", "Supply Chain", "Inventory", "Analytics", "Business Intelligence"],
      evidence: "verified",
      verificationStatus: "requires-confirmation",
      notes: "Exact employment dates require manual confirmation. Tools/achievements must not be invented.",
      relatedWorkIds: ["data-analyst-portfolio", "cross-channel-workflow-automation"],
    },
  ],
